...
namespace OmegaWare_BlushBlush.UI;
    ...
    internal void Render(ConfigFile configFile)
    {
        ...
        ModContext.State.MenuRect = GUI.Window(0, ModContext.State.MenuRect, _ =>
        {
            ...
            if (GUILayout.Button("Unlock All Guys", GUILayout.Height(menuControlHeight)))
                ModContext.Actions.UnlockAllGuys();
            ...
            if (GUILayout.Button("Meet Current Guy Heart Requirement", GUILayout.Height(menuControlHeight)))
                ModContext.Actions.MeetCurrentGuyHeartRequirement();

            if (GUILayout.Button("Meet All Current Guy Requirements", GUILayout.Height(menuControlHeight)))
                ModContext.Actions.MeetAllCurrentGuyRequirements();
